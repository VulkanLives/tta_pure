...
command_frame = ctk.CTkFrame (master=root, fg_color="black", border_color="black", width=700, height=400)
command_frame.pack (side="top")

# output for dice score
main_roll_frame = ctk.CTkFrame (
    master=command_frame, fg_color="transparent", border_color="red",border_width=2, width=300,  height=400
)
main_roll_frame.pack (side="top", fill = "both")

# user_input_frame = ctk.CTkFrame(master=main_roll_frame, fg_color="transparent", border_width=5, border_color="black")
# user_input_frame = ctk.CTkFrame (
#     master=main_roll_frame, fg_color="transparent", height=240,
#     width=350
# )
user_input_frame = ctk.CTkFrame (
    master=main_roll_frame, fg_color="transparent",width=200
)
user_input_frame.pack (side="left", fill= "both", ipady=20)
print("user frame width = " +str(main_roll_frame.winfo_width()))

# hit_wound_icon_frame = ctk.CTkFrame (
#     master=main_roll_frame, fg_color="transparent", height=100,
#     width=100
# )
# hit_wound_icon_frame.pack(side= "right")
#
#
...
# quick_roll_res_frm = ctk.CTkFrame (master=quick_res_frame, fg_color="red", border_color="yellow", width=300, height=100)
# quick_roll_res_frm.pack (side="top")

roll_frame_x = ctk.CTkFrame (
    master=main_roll_frame, fg_color="blue", border_color="yellow", height=120, width=200
)
roll_frame_x.pack (side="bottom", anchor="w")

# hnw = hits and wounds, the results that show occurances of eaach di e.g. fours 6s, no 1s and three 5s
hnw_img_frm = ctk.CTkFrame (
    master=roll_frame_x, fg_color="transparent", border_color="yellow", border_width=2, width=325
)
hnw_res_frm = ctk.CTkFrame (
    master=roll_frame_x, fg_color="transparent", border_color="brown", border_width=2, width=325
)
hnw_img_frm.pack (side='top')
hnw_res_frm.pack (side='top')
...
wnd_img_frm.pack (side='top')
wnd_res_frm.pack (side='top')

dice_frame = ctk.CTkFrame (
    command_frame, fg_color="transparent", border_color="orange", border_width=2,
    # label_text="Roll Log",
    width=200, height=200
)
dice_frame.pack (side='right')
#check_box_frame = ctk.CTkFrame (master=command_frame, fg_color="transparent", border_color="black", width=200)
# check_box_frame = ctk.CTkFrame(master=command_frame, fg_color="transparent", border_color="black", width=200)
...
lbl = ctk.CTkLabel (
    user_input_frame, fg_color="transparent", text="Singles", bg_color="transparent",
    width=35, height=5, font=hint_font, text_color="white"
).grid (row=1, column=1, padx=10, pady=10, sticky="N")
lbl = ctk.CTkLabel (
    user_input_frame, fg_color="transparent", text="Handfuls", bg_color="transparent",
    width=35, height=5, font=hint_font, text_color="white"
...
lbl = ctk.CTkLabel (
    user_input_frame, fg_color="transparent", text="To Hit", bg_color="transparent",
    width=35, height=5, font=hint_font, text_color="white"
).grid (row=4, column=1, padx=5, pady=5, sticky="N")
lbl = ctk.CTkLabel (
    user_input_frame, fg_color="transparent", text="To Wound", bg_color="transparent",
    width=35, height=5, font=hint_font, text_color="white"
...
#     master=main_roll_frame, fg_color="transparent", border_color="red", border_width=2, height=300, width=300
#     )
...
#    master=command_frame, fg_color="transparent", border_color="orange",
...
def load_screen (rec, hit_num, wnd_num, wnds_made, wnd_whole):
    ...
    #
    #    # ctk.CTkLabel(master=score_frame_img, fg_color="transparent", text='\u2680', font=di_font_setup,width=25).grid(row=1, column=1 ,sticky="W",pady=10)
    # def vertical_view ():
    #     roll_frame_y.pack (side="left", fill="both")
    #     score_frame_img = ctk.CTkFrame (master=roll_frame_y, fg_color="transparent", width=55)
    #     score_frame_text = ctk.CTkFrame (master=roll_frame_y, fg_color="transparent", width=55)
    #     score_frame_img.pack (side='left', fill='both')
    #     score_frame_text.pack (side='left', fill='both')
    #
    #     ctk.CTkLabel (
    #         master=score_frame_img, fg_color="transparent", text="", image=d_one_img, bg_color="transparent",
    #         width=25
    #     ).grid (row=1, column=1, sticky="W", pady=10, padx=10)
    #     ctk.CTkLabel (
    #         master=score_frame_text, text=ones, bg_color="white", font=di_font_setup, width=35, height=35
    #         ).grid (
    #         row=1, column=2, sticky="W", pady=10
    #     )
    #
    #     ctk.CTkLabel (
    #         master=score_frame_img, fg_color="transparent", text="", image=d_two_img, bg_color="transparent",
    #         width=35, height=35
    #     ).grid (row=2, column=1, pady=10)
    #     ctk.CTkLabel (
    #         master=score_frame_text, text=twos, bg_color="white", font=di_font_setup, width=35, height=35
    #         ).grid (
    #         row=2, column=2, pady=10, sticky="W"
    #     )
    #
    #     ctk.CTkLabel (
    #         master=score_frame_img, fg_color="transparent", text="", image=d_three_img,
    #         bg_color="transparent",
    #         width=35, height=35
    #     ).grid (row=3, column=1, pady=10)
    #     ctk.CTkLabel (
    #         master=score_frame_text, text=threes, bg_color="white", font=di_font_setup, width=35, height=35
    #         ).grid (
    #         row=3, column=2, pady=10, sticky="W"
    #     )
    #
    #     ctk.CTkLabel (
    #         master=score_frame_img, fg_color="transparent", text="", image=d_four_img, bg_color="transparent",
    #         width=35, height=35
    #     ).grid (row=4, column=1, pady=10, sticky="W", padx=10)
    #     ctk.CTkLabel (
    #         master=score_frame_text, text=fours, bg_color="white", font=di_font_setup, width=35, height=35
    #         ).grid (
    #         row=4, column=2, sticky="W", pady=10
    #     )
    #
    #     ctk.CTkLabel (
    #         master=score_frame_img, fg_color="transparent", text="", image=d_five_img, bg_color="transparent",
    #         width=35, height=35
    #     ).grid (row=5, column=1, pady=10, )
    #     ctk.CTkLabel (
    #         master=score_frame_text, text=fives, bg_color="white", font=di_font_setup, width=35, height=35
    #         ).grid (
    #         row=5, column=2, sticky="W", pady=10
    #     )
    #
    #     ctk.CTkLabel (
    #         master=score_frame_img, fg_color="transparent", text="", image=d_six_img, bg_color="transparent",
    #         width=35
    #     ).grid (row=6, column=1, pady=10, )
    #     ctk.CTkLabel (
    #         master=score_frame_text, text=sixes, bg_color="white", font=di_font_setup, width=35, height=35
    #         ).grid (
    ...
    # # roll_frame_y.pack(side="left",fill="both")
    #
    # print ("dice frame hieght =" + str (roll_frame_x.winfo_height ()))
    # print ("dice frame width =" + str (roll_frame_x.winfo_width ()))

    ctk.CTkLabel (
        master=hnw_img_frm, fg_color="transparent", text="", image=d_one_img, bg_color="transparent",
        width=25
    ...
    ctk.CTkLabel (
        master=hnw_img_frm, fg_color="transparent", text="", image=d_two_img, bg_color="transparent",
        width=35, height=35
    ...
    ctk.CTkLabel (
        master=hnw_img_frm, fg_color="transparent", text="", image=d_three_img,
        bg_color="transparent", width=35, height=35
    ...
    ctk.CTkLabel (
        master=hnw_img_frm, fg_color="transparent", text="", image=d_four_img, bg_color="transparent",
        width=35, height=35
    ...
    ctk.CTkLabel (
        master=hnw_img_frm, fg_color="transparent", text="", image=d_five_img, bg_color="transparent",
        width=35, height=35
    ...
    ctk.CTkLabel (
        master=hnw_img_frm, fg_color="transparent", text="", image=d_six_img, bg_color="transparent",
        width=35
    ...
    ctk.CTkLabel (
        master=user_input_frame, fg_color="transparent", text="", image=hits_icon, bg_color="transparent",
        width=35
    ).grid (row=2, column=5, pady=2, padx=20, rowspan=2)
    ctk.CTkLabel (master=user_input_frame, text=hits, bg_color="white", font=di_font_setup, width=35, height=35).grid (
        row=3,
        column=5,
        pady=20,padx=20,rowspan=2
    )
    ctk.CTkLabel (
        master=user_input_frame, fg_color="transparent", text="", image=wounds_icon, bg_color="transparent",
        width=35
    ).grid (row=2, column=8, pady=2, padx=1,rowspan=2)
    ctk.CTkLabel (master=user_input_frame, text=wnd_num, bg_color="white", font=di_font_setup, width=35, height=35).grid (
        row=3,
        column=8,
        pady=2, padx=1, sticky='W',rowspan=2
    )

    # output_frame = ctk.CTkFrame (
    #    master=root, fg_color="transparent", border_color="black", border_width=2, height=350,
    #    width=700
    # )
    ...
    def horizontal_wound_view ():
        for i in range (6):
            ctk.CTkLabel (
                master=wnd_img_frm, fg_color="transparent", text="", image=d_img_arr[i],
                bg_color="transparent",
                width=25
...
def show_history ():
    ...
    if valid_check > 0:
        ...
        hist_frame = ctk.CTkFrame (
            master=roll_history_win, fg_color="transparent", width=400, height=200,
            border_color="black"
        )
        print (grid_display)
        ...
        literal_roll_log = ctk.CTkLabel (
            master=hist_frame, fg_color="transparent",
            text=str ("Roll") + str (roll_count) + str (string_roll[roll_count - 1]),
            font=literal_font_setup
        )
        literal_roll_log.pack ()
        ctk.CTkLabel (
            master=roll_history_win, fg_color="transparent", text="Breakdown of Session"
        ).pack ()
        btm_frame = ctk.CTkScrollableFrame (
            master=roll_history_win, fg_color="transparent", border_width=2,
            width=200, height=200,
            border_color="black"
        )
        ctk.CTkLabel (
            master=hist_frame, fg_color="transparent", text=str (rolled) + " rolls : ",
            font=font_setup
        ).grid (row=2, column=1, pady=10)
        ctk.CTkLabel (
            master=hist_frame, fg_color="transparent", text='\u2680' + str (current_session_log.count (1)),
            font=font_setup
        ).grid (row=2, column=2, pady=10)
        ctk.CTkLabel (
            master=hist_frame, fg_color="transparent", text='  ',
            font=font_setup
        ).grid (row=2, column=3, pady=10)
        ctk.CTkLabel (
            master=hist_frame, fg_color="transparent", text='\u2681' + str (current_session_log.count (2)),
            font=font_setup
        ...
        ctk.CTkLabel (
            master=hist_frame, fg_color="transparent", text="\u2682" + str (current_session_log.count (3)),
            font=font_setup
        ).grid (row=2, column=6)
        ctk.CTkLabel (
            master=hist_frame, fg_color="transparent", text='  ',
        ...
        ctk.CTkLabel (
            master=hist_frame, fg_color="transparent", text="\u2683" + str (current_session_log.count (4)),
            font=font_setup
        ).grid (row=2, column=8)
        ctk.CTkLabel (
            master=hist_frame, fg_color="transparent", text='  ',
        ...
        ctk.CTkLabel (
            master=hist_frame, fg_color="transparent", text="\u2684" + str (current_session_log.count (5)),
            font=font_setup
        ...
        ctk.CTkLabel (
            master=hist_frame, fg_color="transparent", text="\u2685" + str (current_session_log.count (6)),
            font=font_setup
        ).grid (row=2, column=13)
        score_log_scroll = ctk.CTkScrollableFrame (
            master=hist_frame, orientation="vertical", fg_color="transparent", label_text="Score Log", width=300,
            height=50
            )
        score_log_scroll.pack (side='left', fill="both")

        mini_w_result_frame = ctk.CTkFrame (
            master=hist_frame, fg_color="transparent", border_color="grey", border_width=3, width=300
            )
        mini_w_result_frame.pack (side='top', fill="both")
    # hist_frame.pack ()
    # ctk.CTkLabel (
    #            master=roll_history_win, fg_color="transparent", text="Average"
    #        ).pack ()
    for result in range (roll_count):
        # display each roll each on new line
        dice_lbl = ctk.CTkLabel (
            btm_frame, fg_color="transparent",
...
def display_intance (hr, hs, wr, ws, sb, wb):
    ...
    def show_hit ():
        ...
        for di in range (dice_thrown):
            ...
            #   lbl.pack(side='left', anchor= 'ne', ipadx = 0 )
            hr_lbl.grid (row=int (row_grid_plot), column=int (column_grid_plot))
            print ("grid plit images" + str (column_grid_plot))
    ...
    def show_wound (row_num):
        ...
        w_roll_header = ctk.CTkLabel (master=dice_frame, text="Roll to Wound  ", font=hint_font, anchor="center")
        w_roll_header.grid (row=(w_row_grid_plot - 1), column=1, columnspan=4)
        ...
        for wnd_di in range (w_dice_thrown):
            ...
            #   lbl.pack(side='left', anchor= 'ne', ipadx = 0 )
            wr_lbl.grid (row=int (w_row_grid_plot), column=int (w_column_grid_plot), padx=3)
...
#             master=mini_w_result_frame, fg_color="transparent",
...
#
roll_btn = ctk.CTkButton (master=user_input_frame, text="Roll", height=90, width=150, command=roll_new)
roll_btn.grid (row=7, rowspan=4, column=1, columnspan=4, sticky='W', padx=15)
clear_btn = ctk.CTkButton (master=user_input_frame, text="Reset", width=85, command=clr)
clear_btn.grid (row=11, column=1, columnspan=1, pady=10)
# clear_btn.pack (side='bottom')
quit_btn = ctk.CTkButton (master=user_input_frame, text="Quit", width=85, command=root.quit)
# quit_btn.pack(side='bottom')
quit_btn.grid (row=11, column=2, columnspan=1, pady=10)
# if hnw_mode:
#
#
